...
export const Page = () => {
    ...
    return (React.createElement("article", null,
        ...
        React.createElement("section", { className: "font-['Nunito_Sans','Helvetica_Neue',Helvetica,Arial,sans-serif] text-[14px]/[24px] px-[20px] py-[48px] my-0 mx-auto max-w-[600px] text-[#333]" },
